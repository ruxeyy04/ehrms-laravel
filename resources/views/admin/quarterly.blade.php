        ...
        <div class="fx-card">
            <div class="row">
                <div class="col-md-12 text-center mt-3">
                    ...
                    <h4 class="fx-card-title text-center mt-2 text-danger fw-bolder">Quarterly</h4>
                    <h4 class="fx-card-title text-center mt-2 text-danger fw-bolder">Division Wide</h4>
                </div>
            </div>
            <div class="row">
                <div id="dealtbl">
