    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-4 col-md-4">
                <a href="{{ route('admin.cotplanningLesson') }}" class="fx-page-link">
            ...
            <div class="col-xl-4 col-md-4">
                <a href="{{ route('admin.cotpresentingLesson') }}" class="fx-page-link">
                    <div class="fx-card special third">
                        <div class="fx-card-content label-card">
                            <div class="title">
                                <div class="growth-numbers mt-4">
            ...
            <div class="col-xl-4 col-md-4">
                <a href="{{ route('admin.cotclassroomManagement') }}" class="fx-page-link">
                    <div class="fx-card special third">
                        <div class="fx-card-content label-card">
                            <div class="title">
                                <div class="growth-numbers mt-4">
        ...
        <div class="row justify-content-center">
            <div class="col-xl-4 col-md-4">
                <a href="{{ route('admin.cotassessmentLearning') }}" class="fx-page-link">
                    <div class="fx-card special third">
                        <div class="fx-card-content label-card">
                            <div class="title">
                                <div class="growth-numbers mt-4">
