<x-app-layout>
            ...
            <div class="col-xl-12 col-md-12">
                <div class="fx-card" id="dealtbl">
                    <div class="fx-card-header">
                        <h4 class="fx-card-title">Public Schools District Supervisor List</h4>
                        <div class="header-tools">
                            ...
                            <button type="button" class="fx-btn ripple-btn color-dark" data-bs-toggle="modal"
                                data-bs-target="#addPSDS" style="height: 30px !important"><i
                                    class="ri-user-add-line m-r-10"></i>PSDS</button>
                        </div>
                    </div>
                    <div class="fx-card-content card-default">
                        <div class="container-fluid">
                            <table class="table" id="psds-table-list">
                                <thead class="table__thead">
                                    <tr>
                                        <th class="table__th sorting">PSDS NAME</th>
    ...
    <x-modal icon="ri-user-add-line" modal_title="Public Schools District Supervisor" modal_type="fade" id="addPSDS" tabindex="-1"
        aria-labelledby="addPSDSLabel" aria-hidden="true" modal_size="modal-xl" modal_mode="modal-dialog-centered"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="sel sel-unactive form-group mb-3 ">
                                                        <select class="sele form-control" name="job_title">
                                                            ...
                                                            @if ($jobtitle->job_title == "Public Schools District Supervisor")
