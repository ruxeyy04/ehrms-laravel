        ...
        <div class="fx-card">
            ...
            <div class="row">
                <div class="col-xl-6 col-md-6">
                    <div class="fx-card-content px-4">
                        <div class="fx-card-header split">
                            <h4 class="fx-card-title">PROFICIENT (TOTAL OF 1115 PER SUBJECT)</h4>
                        ...
                        <div class="fx-card-content">
                            <div class="fx-chart-content">
                                <div id="subjectareaBarChart1"></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-md-6">
                    <div class="fx-card-content px-4">
                        <div class="fx-card-header split">
                            <h4 class="fx-card-title">HIGHLY PROFICIENT (TOTAL OF 88 PER SUBJECT)</h4>
                            <div class="header-tools">
                                <a href="javascript:void(0)" class="fx-full-card" title="Full Screen"><i
                                        class="ri-fullscreen-line"></i></a>
                            </div>
                        ...
                        <div class="fx-card-content">
                            <div class="fx-chart-content">
                                <div id="subjectareaBarChart2"></div>
                            </div>
                        </div>
                    </div>
                </div>
