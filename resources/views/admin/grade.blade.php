        ...
        <div class="fx-card">
            <div class="row">
                <div class="col-md-12 text-center mt-3">
                    ...
                    <h4 class="fx-card-title text-center mt-2 text-primary fw-bolder">Total - Quarter (1-4)</h4>
                </div>
            </div>
            <div class="row">
                <div id="dealtbl">
                    <div class="form-group mb-3 p-3">
                        ...
                        <small class="text-secondary">Note : Click select button at the right to display the chosen category.</small>
                    </div>
