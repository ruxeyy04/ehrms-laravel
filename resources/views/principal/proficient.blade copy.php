    ...
    <div class="container-fluid">
        ...
        <div class="fx-card">
            <div class="fx-card-content px-4">
                ...
                <h5 class="fx-card-title text-center mt-2 text-success fw-bolder">TEACHER I-III</h5>
                <div class="row">
                    <div class="col-md-3">
                        <div class="fx-card">
                                        ...
                                        <table id="recent-employee-table" class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="form-group">
                                                            <p>1. Applies knowledge of content within and across
                                                                curriculum teaching areas.</p>
                                                        </div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="form-group">
                                                            <p>2. Uses a range of teaching strategies that enhance
                                                                learning achievement in literacy and numeracy skills.
                                                            </p>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="form-group">
                                                            <p>3. Applies a range of teaching strategies to develop
                                                                critical and creative thinking, as well asother
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="form-group">
                                                            <p>4. Manages classroom structure to engage
                                                                learners,individually or in group,in meaningful
                                                                exploration,discovery and hands-on activities within a
                                                                range of physical learning environments.</p>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                value="" id="flexCheckIndeterminate">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="form-group">
                                                            <p>5. Manages learner behavior constructively by applying
                                                                positive and non-violent descipline to ensure
                                                                learning-focused environments.</p>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                value="" id="flexCheckIndeterminate">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="form-group">
                                                            <p>6. Uses differentiated,developmentall appropriate
                                                                learning experiences to address learners'
                                                                gender,needs,strengths,interest, and experiences.</p>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                value="" id="flexCheckIndeterminate">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="form-group">
                                                            <p>7. Plans,manages and implements developmentally sequenced
                                                                teaching and learning processes to meet curriculum
                                                                requirements and varied teaching contexts.</p>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                value="" id="flexCheckIndeterminate">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="form-group">
                                                            <p>8. Selects,develops,organizes, and uses appropriate
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="form-group">
                                                            <p>9. Designs,selects,organizes,and uses
                                                                diagnostic,formative and summative assessment strategies
                                                                consistent with curriculum requirements.</p>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                value="" id="flexCheckIndeterminate">
