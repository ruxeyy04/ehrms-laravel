                                        ...
                                        <tbody>
                                            <tr>
                                                <th colspan="8" class="table-warning">
                                                    <p>C. Classroom Management ( Check/Tick the area/areas needing
                                                        enhancement )</p>
                                                </th>
                                            </tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-check">
                                                        ...
                                                        <p class="mx-3">establishing routines and procedure to
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value=""
                                                            id="flexCheckIndeterminate">
                                                        <p class="mx-3"> maintaining a clean, safe and child-friendly
                                                            classroom that is compliant to the child protection policy
                                                        </p>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value=""
                                                            id="flexCheckIndeterminate">
                                                        <p class="mx-3">managing learner behavior constructively by
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value=""
                                                            id="flexCheckIndeterminate">
                                                        <p class="mx-3">structuring the classroom to encourage
                                                            learners to do meaningful exploration, discovery and
                                                            hands-on activities
                                                        </p>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-check">
                                                        ...
                                                        <p class="mx-3">nurturing sense of responsibility among
                                                            learners by involving them in making classroom rules and
                                                            standards</p>
                                                    </div>
                                                </td>
                                            </tr>
