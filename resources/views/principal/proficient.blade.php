        ...
        <div class="fx-card container-fluid">
            <div class="row mb-3">
                <div class="col-md-12 text-center mt-3">
                    ...
                    <h6 class="fx-card-title text-center mt-2 text-success fw-bolder">TEACHER I-III</h6>
                </div>
            </div>
            <div class="row">
                <form action="">
                                            ...
                                            <tbody class="table__tbody">
                                                ...
                                                <tr class="table-row" data-question="2">
                                                    <td class="table-row__td" data-column="Question No. 2">
                                                        ...
                                                        <p class="custom-p__table question">
                                                        2. Uses a range of teaching strategies that enhance learning achievement in literacy and numeracy skills.
                                                        </p>
                                                    </td>
                                                    <td class="td-opt" data-column="3">
                                                        <div class="form-check">
                                                ...
                                                <tr class="table-row" data-question="3">
                                                    <td class="table-row__td" data-column="Question No. 3">
                                                        <div class="table-row--info mr-3"></div>
                                                        <p class="custom-p__table question">
                                                        3. Applies a range of teaching strategies to develop critical and creative thinking, as well asother higher-order thinking skills.
                                                        </p>
                                                    </td>
                                                    <td class="td-opt" data-column="3">
                                                        <div class="form-check">
                                                ...
                                                <tr class="table-row" data-question="4">
                                                    <td class="table-row__td" data-column="Question No. 4">
                                                        <div class="table-row--info mr-3"></div>
                                                        <p class="custom-p__table question">
                                                        4. Manages classroom structure to engage learners,individually or in group,in meaningful exploration,discovery and hands-on activities within a range of physical learning environments.
                                                        </p>
                                                    </td>
                                                    <td class="td-opt" data-column="3">
                                                        <div class="form-check">
                                                ...
                                                <tr class="table-row" data-question="5">
                                                    <td class="table-row__td" data-column="Question No. 5">
                                                        <div class="table-row--info mr-3"></div>
                                                        <p class="custom-p__table question">
                                                        5. Manages learner behavior constructively by applying positive and non-violent descipline to ensure learning-focused environments.
                                                        </p>
                                                    </td>
                                                    <td class="td-opt" data-column="3">
                                                        <div class="form-check">
                                                ...
                                                <tr class="table-row" data-question="6">
                                                    <td class="table-row__td" data-column="Question No. 6">
                                                        <div class="table-row--info mr-3"></div>
                                                        <p class="custom-p__table question">
                                                        6. Uses differentiated,developmentall appropriate learning experiences to address learners' gender,needs,strengths,interest, and experiences.
                                                        </p>
                                                    </td>
                                                    <td class="td-opt" data-column="3">
                                                        <div class="form-check">
                                                ...
                                                <tr class="table-row table-category-color p-0 table-total__tally table-success">
                                                    <td class="text-end">
                                                        <b>TOTAL</b>
                                                    </td>
