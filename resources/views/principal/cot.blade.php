    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-4 col-md-4">
                <a href="{{ route('principal.cotplanningLesson') }}" class="fx-page-link">
            ...
            <div class="col-xl-4 col-md-4">
                <a href="{{ route('principal.cotpresentingLesson') }}" class="fx-page-link">
                    <div class="fx-card special secondary">
                        <div class="fx-card-content label-card">
                            <div class="title">
                                <div class="growth-numbers mt-4">
            ...
            <div class="col-xl-4 col-md-4">
                <a href="{{ route('principal.cotclassroomManagement') }}" class="fx-page-link">
                    <div class="fx-card special secondary">
                        <div class="fx-card-content label-card">
                            <div class="title">
                                <div class="growth-numbers mt-4">
        ...
        <div class="row justify-content-center">
            <div class="col-xl-4 col-md-4">
                <a href="{{ route('principal.cotassessmentLearning') }}" class="fx-page-link">
                    <div class="fx-card special secondary">
                        <div class="fx-card-content label-card">
                            <div class="title">
                                <div class="growth-numbers mt-4">
            ...
            <div class="col-xl-4 col-md-4">
                <a href="{{ route('principal.cotoverallAssessment') }}" class="fx-page-link">
                    <div class="fx-card special secondary">
                        <div class="fx-card-content label-card">
                            <div class="title">
                                <div class="title">
